...
import { FinalScene } from "./FinalScene"; //Початкова сцена Гри з показом демо на фоні
//і початковим меню
...
export class StartScene extends GameScene {
  ...
  _updateBall(dt, ball) {
    super._updateBall(dt, ball); //Дозволити політ шара після початкового встановлення на дошку
