...
/* harmony import */ var _StartScene__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./StartScene */ "./src/StartScene.js");
...
function () {
  ...
  _createClass(FinalScene, [{
    ...
    value: function _init() {
      ...
      this._infoText = text;
      this._info = new _components__WEBPACK_IMPORTED_MODULE_0__["Info"]("");
    }
  }, {
    key: "update",
    ...
    value: function _checkKey() {
      if (this._game.checkKeyPress(13) || this._game.checkKeyPress(27)) {
        ...
        this._game.setScene({
          scene: _StartScene__WEBPACK_IMPORTED_MODULE_1__["StartScene"],
          isClear: true
        });
      }
    }
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components */ "./src/components.js");
/* harmony import */ var _GameScene__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GameScene */ "./src/GameScene.js");
/* harmony import */ var _FinalScene__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FinalScene */ "./src/FinalScene.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(GameOverScene, [{
    ...
    value: function _setFinalScene(gameStatus) {
      ...
      this._game.setScene({
        scene: _FinalScene__WEBPACK_IMPORTED_MODULE_2__["FinalScene"],
...
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/jquery-3.4.1 */ "./lib/jquery-3.4.1.js");
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _PauseScene__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./PauseScene */ "./src/PauseScene.js");
/* harmony import */ var _GameOverScene__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./GameOverScene */ "./src/GameOverScene.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function GameScene(game) {
    ...
    this._deffBall = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default.a.Deferred();
    this._deffBoard = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default.a.Deferred(); //this._isLoadBall = false;
  ...
  _createClass(GameScene, [{
    ...
    value: function _initBoard() {
      ...
      this._board = new _board__WEBPACK_IMPORTED_MODULE_1__["Board"]({
    ...
    value: function _initBall() {
      ...
      this._ball = new _ball__WEBPACK_IMPORTED_MODULE_2__["Ball"]({
        game: this,
      ...
      this._deffBall.done(function () {
        _this2._ball.setRadius(_this2._ballElem.outerWidth() / 2); //this._isLoadBall = true;
    ...
    value: function _initBlocks(round) {
      ...
      for (var i = 0; i < round.length; i++) {
        ...
        for (var j = 0; j < round[i].length; j++) {
          ...
          if (round[i][j] === "w") {
            block = new _block__WEBPACK_IMPORTED_MODULE_3__["Block"]({
              x: x,
              y: y,
    ...
    value: function _updateBall(dt, ball) {
      ...
      ball.speed = _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].FromObj(ball.direction.scalar(dt * ball.speedCoef)); //генерує помилку при перевищенні швидкості в 30
    ...
    value: function _calcBallPosition(dt, ball) {
      ...
      if (ball.direction.y > 0) {
        if (_block__WEBPACK_IMPORTED_MODULE_3__["Block"].isTouchBlockVsBall(this._board, ball)) {
    ...
    value: function _calcTouchedBorderPos(position, ball) {
      ...
      for (var key in obj) {
        ...
        if (obj[key] > distance) {
          ...
          if (key === "left" || key === "right") {
            ball.newDirection = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](-1 * ball.direction.x, ball.direction.y);
          } else {
            ball.newDirection = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](ball.direction.x, -1 * ball.direction.y);
          }
        }
      }
      ...
      ball.border.direction = _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].FromObj(ball.newDirection);
    ...
    value: function _isTouchBlocksVsBall(ball) {
      ...
      this._blockArr.forEach(function (block) {
        if (_block__WEBPACK_IMPORTED_MODULE_3__["Block"].isTouchBlockVsBall(block, ball)) {
    ...
    value: function _calcTouchedBlockPos(ball) {
      ...
      var normalH = ball.getNormal(new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](Math.sign(ball.direction.x), 0));
      var normalV = ball.getNormal(new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](0, Math.sign(+ball.direction.y))); //якщо є дотик до сторони, то не перевіряти далі
      ...
      var vertex = _block__WEBPACK_IMPORTED_MODULE_3__["Block"].findNearVertex(this._touchedBlockArr[0], ball);
    ...
    value: function _calcSideBlockRebound(normalH, normalV, ball) {
      ...
      if (distH > distV) {
        dist = distH;
        block = blockH;
        ball.newDirection = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](-Math.sign(normalH.x) * ball.direction.x, ball.direction.y);
      } else {
        dist = distV;
        block = blockV;
        ball.newDirection = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](ball.direction.x, -Math.sign(+normalV.y) * ball.direction.y);
      }
      ...
      ball.block.direction = _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].FromObj(ball.newDirection);
    ...
    value: function _calcVertexRebound(block, ball, vertex) {
      ...
      var normal = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](-vecCentrToVertex.y, vecCentrToVertex.x); //кут між напрямком руху і вектором з центра до вершини
    ...
    value: function _calcTouchedBoardPos(ball, board) {
      ball.board = {};
      ball.board.position = _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].FromObj(ball.position);
      ...
      var normal = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"](-vecCentrToVertex.y, vecCentrToVertex.x);
      var angle = Math.acos(_components__WEBPACK_IMPORTED_MODULE_4__["Vector"].scalarMult(ball.direction, vecCentrToVertex.norm()));
      var sign = Math.sign(_components__WEBPACK_IMPORTED_MODULE_4__["Vector"].scalarMult(normal, ball.direction));
    ...
    value: function _checkKeys() {
      ...
      if (this._game.checkKeyPress(13) || this._game.checkKeyPress(27)) {
        ...
        this._game.setScene({
          scene: _PauseScene__WEBPACK_IMPORTED_MODULE_5__["PauseScene"],
          isClear: false
        });
    ...
    value: function gameOver(gameStatus) {
      ...
      this._game.setScene({
        scene: _GameOverScene__WEBPACK_IMPORTED_MODULE_6__["GameOverScene"],
        isClear: false,
        gameStatus: gameStatus
      });
    }
...
/*!**************************!*\
  !*** ./src/HelpScene.js ***!
  \**************************/
/*! exports provided: HelpScene */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HelpScene", function() { return HelpScene; });
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/jquery-3.4.1 */ "./lib/jquery-3.4.1.js");
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0__);
...
function () {
  ...
  _createClass(HelpScene, [{
    key: "_init",
    value: function _init() {
      this._menu = new _components__WEBPACK_IMPORTED_MODULE_1__["Menu"]({
        header: "Game help",
        menuItems: ["Back"]
      });
      this._help = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("help");
      var table = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<table></table>").addClass("help-table").appendTo(this._help);
      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<tr></tr>").html("<th>Action: </th> <th>Key</th>").appendTo(table);
      ...
      for (var key in this._itemsObj) {
        ...
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<tr></tr>").html("<td>".concat(key, ": </td> <td>").concat(this._itemsObj[key], "</td>")).appendTo(table);
      }
      /*
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components */ "./src/components.js");
/* harmony import */ var _GameOverScene__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GameOverScene */ "./src/GameOverScene.js");
/* harmony import */ var _HelpScene__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./HelpScene */ "./src/HelpScene.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(PauseScene, [{
    key: "_init",
    value: function _init() {
      var menu = new _components__WEBPACK_IMPORTED_MODULE_0__["Menu"]({
        header: "Pause",
    ...
    value: function update() {
      ...
      if (this._game.checkKeyPress(13)) {
        switch (this._menu.getSelectedItem().attr("data-name")) {
          ...
          case "help":
            this._setScene(_HelpScene__WEBPACK_IMPORTED_MODULE_2__["HelpScene"]);
...
/* harmony import */ var _HelpScene__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./HelpScene */ "./src/HelpScene.js");
/* harmony import */ var _FinalScene__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./FinalScene */ "./src/FinalScene.js");
...
function (_GameScene) {
  ...
  function StartScene(game) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(StartScene).call(this, game));
  ...
  _createClass(StartScene, [{
    ...
    value: function _initMenu() {
      var menu = new _components__WEBPACK_IMPORTED_MODULE_2__["Menu"]({
        header: "Ricochet",
    ...
    value: function _initBall() {
      ...
      this._ball = new _ball__WEBPACK_IMPORTED_MODULE_3__["Ball"]({
        game: this,
        speed: 500,
        direction: {
          x: 0.1,
    ...
    key: "render",
    value: function render(dt) {
      if (!this._game.gameField.find("*").is(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()(this._menuElem))) {
        this._game.gameField.append(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()(this._menuElem));
      }
      ...
      if (this._game.checkKeyPress(13)) {
        switch (this._menu.getSelectedItem().attr("data-name")) {
          ...
          case "help":
            ...
            this._game.setScene({
              scene: _HelpScene__WEBPACK_IMPORTED_MODULE_4__["HelpScene"],
              isClear: false
            });
          ...
          case "quit":
            ...
            this._game.setScene({
              scene: _FinalScene__WEBPACK_IMPORTED_MODULE_5__["FinalScene"],
              gameStatus: "noPlay",
              isClear: false
            });
  ...
  return StartScene;
}(_GameScene__WEBPACK_IMPORTED_MODULE_1__["GameScene"]);
...
function () {
  function Ball(options) {
    ...
    this._startDirection = _components__WEBPACK_IMPORTED_MODULE_1__["Vector"].FromObj(options.direction || {
      x: 0.1,
      y: -1
    }); // this._radius = 30;
  ...
  _createClass(Ball, [{
    key: "_init",
    value: function _init() {
      this._ball = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("ball");
    ...
    value: function calcCentr(coord) {
      ...
      var resX = Object(_components__WEBPACK_IMPORTED_MODULE_1__["calcQuad"])(a, b, c);
      ...
      if (resX.x_1 * this.direction.x < resX.x_2 * this.direction.x) {
        return new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](resX.x_1, k * resX.x_1 + d);
      } else {
        return new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](resX.x_2, k * resX.x_2 + d);
      }
...
function () {
  ...
  _createClass(Block, [{
    key: "_init",
    value: function _init() {
      var block = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("block").addClass(this._blockClass);
      block.css({
        left: this._x,
        top: this._y
      });
    ...
    value: function _initVertexes() {
      this._A = new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](this.left(), this.top());
      this._B = new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](this.right(), this.top());
      this._C = new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](this.right(), this.bottom());
      this._D = new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](this.left(), this.bottom());
    }
  }, {
    key: "isContainCoord",
...
function () {
  ...
  _createClass(Board, [{
    key: "_init",
    value: function _init() {
      this._elem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("board");
    ...
    value: function vecForBallStart(ball) {
      ...
      var y = this._topPosition - this._height / 2 - this._borderWidth - ball.radius; //console.log(x, y);

      return new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](x, y);
    ...
    value: function _boardPointInit() {
      ...
      var bottom = this._gameField.innerWidth(); //точки лівої границі


      for (var i = bottom; i > y_0; i--) {
        pointArr.push(new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](x_0 - a, i));
      } //точки верхньої границі


      for (var _i = -a; _i <= a; _i++) {
        var y = y_0 - b / a * Math.sqrt(a * a - _i * _i);
        pointArr.push(new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](x_0 + _i, y));
      } //точки правої границі


      for (var _i2 = y_0 + 1; _i2 < bottom; _i2++) {
        pointArr.push(new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](x_0 + a, _i2));
      }
    ...
    value: function getPointArr() {
      ...
      this._pointerArr.forEach(function (point) {
        resArr.push(new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"](point.x + delta, point.y));
      });
    ...
    value: function _testPoint() {
      this._pointerArr.forEach(function (point) {
        var elem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("point").css({
          left: point.x,
          top: point.x + 1
        });
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("#game-field").append(elem);
    ...
    value: function renderPoint() {
      var pointArr = this.getPointArr(); //console.log(pointArr);

      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()(".point").each(function (index, elem) {
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()(elem).css({
          left: pointArr[index]
        });
      });
...
/*!***************************!*\
  !*** ./src/components.js ***!
  \***************************/
/*! exports provided: Menu, Header, Round, Info, Vector, calcQuad */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function () {
  ...
  _createClass(Menu, [{
    key: "_init",
    value: function _init() {
      var menuWrapper = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("menu").append(this._initHeader());
    ...
    value: function _initHeader() {
      return _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<h1></h1>").addClass("menu-header").text(this._headerText);
    }
  }, {
    key: "_initMenuList",
    value: function _initMenuList() {
      var menuList = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<ul></ul>").addClass("menu-list");

      this._menuItemsList.forEach(function (item) {
        var listItem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<li></li>").appendTo(menuList);
        var span = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>").appendTo(listItem);
        span.text(item);
        var temp = item.split(" ");
    ...
    value: function _initMarker() {
      this._marker = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("menu-marker");
...
function () {
  ...
  _createClass(Header, [{
    key: "_init",
    value: function _init() {
      var ul = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<ul></ul>").addClass("header-list");
      ...
      for (var key in this._options) {
        ...
        var li = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<li></li>").appendTo(ul);
        var span = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>").addClass(classStr).text("".concat(key, ": ").concat(this._options[key])); //Додає обгортку для показу блоку біля поля Score

        if (key === "Score") {
          _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("header-block").appendTo(li);
        }
    ...
    value: function setRound(str) {
      this._elem.find(".header-round").text("Round: ".concat(str));
    }
  }, {
    key: "setLife",
    value: function setLife(str) {
      this._elem.find(".header-life").text("Life: ".concat(str));
    }
  }, {
    key: "setScore",
    value: function setScore(str) {
      this._elem.find(".header-score").text("Score: ".concat(str));
    }
  }]);
...
function () {
  ...
  _createClass(Info, [{
    key: "_init",
    value: function _init() {
      this._message = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<p></p>").addClass("info-message").text(this._text);
      this._elem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("info").append(this._message);
    }
  }, {
    key: "enableAnimation",
...
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/jquery-3.4.1 */ "./lib/jquery-3.4.1.js");
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function Game(gameField, headerField) {
    ...
    this._score = 0;
    this._stop = false;
    this.round = new _components__WEBPACK_IMPORTED_MODULE_0__["Round"]();
  ...
  _createClass(Game, [{
    ...
    value: function _initEvent() {
      ...
      this.keys = {};
      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("keydown", function (e) {
        _this.keys[e.which] = true;
      });
      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("keyup", function (e) {
      ...
      */
      ...
      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("dragstart", function (event) {
        event.preventDefault();
      });
      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("mousedown", function (event) {
        event.preventDefault();
      });
      ...
      _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("contextmenu", function (event) {
        if (_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(".wrapper *").is(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(event.target))) {
          event.preventDefault();
        }
      });
    ...
    value: function setScene(options) {
      ...
      var scene = new options.scene(this, options.gameStatus); //очищення масиву сцен, якщо запускається
      //GameScene або StartScene

      if (scene instanceof _GameScene__WEBPACK_IMPORTED_MODULE_2__["GameScene"]) {
        this._gameSceneArr = [];
      }
    ...
    value: function returnScene(isOnBoard) {
      var lastScene = this._gameSceneArr.pop(); //Після втрати шара, якщо присутні життя шар повертається на дошку і повертається стара сцена
    ...
    value: function _renderHeader() {
      if (!this.headerField.find("*").is(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(this.header.getElem()))) {
        this.headerField.append(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(this.header.getElem()));
      }
