...
function () {
  function GameScene(game) {
    ...
    this._deffBall = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.Deferred();
    this._deffBoard = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.Deferred(); //this._isLoadBall = false;
...
function () {
  ...
  _createClass(HelpScene, [{
    ...
    value: function _init() {
      ...
      this._help = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("help");
      var table = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<table></table>").addClass("help-table").appendTo(this._help);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("<tr></tr>").html("<th>Action: </th> <th>Key</th>").appendTo(table);
      ...
      for (var key in this._itemsObj) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("<tr></tr>").html("<td>".concat(key, ": </td> <td>").concat(this._itemsObj[key], "</td>")).appendTo(table);
      }
      /*
...
function (_GameScene) {
  ...
  _createClass(StartScene, [{
    ...
    key: "render",
    value: function render(dt) {
      if (!this._game.gameField.find("*").is(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this._menuElem))) {
        this._game.gameField.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this._menuElem));
      }
...
function () {
  ...
  _createClass(Ball, [{
    key: "_init",
    value: function _init() {
      this._ball = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("ball");
...
function () {
  ...
  _createClass(Block, [{
    key: "_init",
    value: function _init() {
      var block = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("block").addClass(this._blockClass);
      block.css({
        left: this._x,
        top: this._y
      });
...
function () {
  ...
  _createClass(Board, [{
    key: "_init",
    value: function _init() {
      this._elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("board");
    ...
    value: function _testPoint() {
      this._pointerArr.forEach(function (point) {
        var elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("point").css({
          left: point.x,
          top: point.x + 1
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#game-field").append(elem);
    ...
    value: function renderPoint() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".point").each(function (index, elem) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(elem).css({
          left: pointArr[index]
        });
      });
...
function () {
  ...
  _createClass(Menu, [{
    key: "_init",
    value: function _init() {
      var menuWrapper = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("menu").append(this._initHeader());
    ...
    value: function _initHeader() {
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()("<h1></h1>").addClass("menu-header").text(this._headerText);
    }
  }, {
    key: "_initMenuList",
    value: function _initMenuList() {
      var menuList = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<ul></ul>").addClass("menu-list");

      this._menuItemsList.forEach(function (item) {
        var listItem = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<li></li>").appendTo(menuList);
        var span = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>").appendTo(listItem);
        span.text(item);
        var temp = item.split(" ");
    ...
    value: function _initMarker() {
      this._marker = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("menu-marker");
...
function () {
  ...
  _createClass(Header, [{
    key: "_init",
    value: function _init() {
      var ul = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<ul></ul>").addClass("header-list");
      ...
      for (var key in this._options) {
        ...
        var li = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<li></li>").appendTo(ul);
        var span = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>").addClass(classStr).text("".concat(key, ": ").concat(this._options[key])); //Додає обгортку для показу блоку біля поля Score

        if (key === "Score") {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("header-block").appendTo(li);
        }
...
function () {
  ...
  _createClass(Info, [{
    key: "_init",
    value: function _init() {
      this._message = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p></p>").addClass("info-message").text(this._text);
      this._elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("info").append(this._message);
    }
  }, {
    key: "enableAnimation",
...
function () {
  ...
  _createClass(Game, [{
    ...
    value: function _initEvent() {
      ...
      this.keys = {};
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).on("keydown", function (e) {
        _this.keys[e.which] = true;
      });
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).on("keyup", function (e) {
      ...
      */
      ...
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).on("dragstart", function (event) {
        event.preventDefault();
      });
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).on("mousedown", function (event) {
        event.preventDefault();
      });
      ...
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).on("contextmenu", function (event) {
        if (jquery__WEBPACK_IMPORTED_MODULE_3___default()(".wrapper *").is(jquery__WEBPACK_IMPORTED_MODULE_3___default()(event.target))) {
          event.preventDefault();
        }
      });
    ...
    value: function _renderHeader() {
      if (!this.headerField.find("*").is(jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.header.getElem()))) {
        this.headerField.append(jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.header.getElem()));
      }
