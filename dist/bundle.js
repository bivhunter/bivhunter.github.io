...
class GameScene {
    constructor( game ) {
        ...
        this._deffBoard = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default.a.Deferred();
    ...
    _updateBall( dt, ball ) {
        ...
        ball.speed = _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].FromObj( ball.direction.scalar( dt * ball.speedCoef ) );
    ...
    _calcTouchedBlockPos( ball ) {
        ...
        let normalH = ball.getNormal( new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"]( Math.sign( ball.direction.x ), 0 ) );
        let normalV = ball.getNormal( new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"]( 0, Math.sign( +ball.direction.y ) ) );
        ...
        let vertex = _block__WEBPACK_IMPORTED_MODULE_3__["Block"].findNearVertex( this._touchedBlockArr[ 0 ], ball );
        if ( vertex === null ) {
    ...
    _calcSideBlockRebound( normalH, normalV, ball ) {
        ...
        if ( distH > distV ) {
            dist = distH;
            block = blockH;
            ball.newDirection = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"]( -Math.sign( normalH.x ) * ball.direction.x,
                ball.direction.y );
        } else {
            dist = distV;
            block = blockV;
            ball.newDirection = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"]( ball.direction.x,
    ...
    _calcVertexRebound( block, ball, vertex ) {
        ...
        let normal = new _components__WEBPACK_IMPORTED_MODULE_4__["Vector"]( -vecCentrToVertex.y, vecCentrToVertex.x );

        //кут між напрямком руху і вектором з центра до вершини
        let angle = Math.acos( _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].scalarMult( ball.direction, vecCentrToVertex.norm() ) );
        let sign = Math.sign( _components__WEBPACK_IMPORTED_MODULE_4__["Vector"].scalarMult( normal, ball.direction ) );
...
class HelpScene {
    ...
    _init() {
        ...
        let table = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<table></table>").addClass("help-table").appendTo(this._help);

        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<tr></tr>").html(`<th>Action: </th> <th>Key</th>`)
            .appendTo(table);
        ...
        for (let key in this._itemsObj) {
            ...
            _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<tr></tr>").html( `<td>${key}: </td> <td>${this._itemsObj[key]}</td>` )
                .appendTo(table);
        }
...
class PauseScene {
	...
	_init() {
		let menu = new _components__WEBPACK_IMPORTED_MODULE_0__["Menu"]({
			header: "Pause",
			menuItems: [
				"Resume",
				"Restart",
...
//і початковим меню
class StartScene extends _GameScene__WEBPACK_IMPORTED_MODULE_1__["GameScene"] {
	constructor(game) {
		super(game);
	}
	...
	_initMenu() {
		let menu = new _components__WEBPACK_IMPORTED_MODULE_2__["Menu"]({
			header: "Ricochet",
			menuItems: [
				"Start Game",
				"Help",
...
class Ball {
    constructor(options) {
        ...
        this._startDirection = _components__WEBPACK_IMPORTED_MODULE_1__["Vector"].FromObj(
            options.direction || {
            x: 0.1,
            y: -1
        });
...
/*        this._ball = document.createElement("div");
    ...
    calcCentr(coord) {
        ...
        let resX = Object(_components__WEBPACK_IMPORTED_MODULE_1__["calcQuad"])(a, b, c);
        if (!resX) {
...
class Block {
	...
	_init() {
		...
		let block = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("block").addClass(this._blockClass);
		block.css({
			left: this._x,
			top: this._y
		});
...
class Board {
    ...
    _boardPointInit() {
        ...
        for ( let i = -a; i <= a; i++ ) {
            ...
            pointArr.push( new _components__WEBPACK_IMPORTED_MODULE_1__["Vector"]( x_0 + i, y ) );
        }
    ...
    _testPoint() {
        this._pointerArr.forEach( point => {
            let elem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("point").css({
                left: point.x,
                top: point.x + 1
            });
    ...
    renderPoint() {
        ...
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()(".point").each((index, elem) => {
...
class Menu {
    ...
    _init() {
        ...
        let menuWrapper = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("menu").append(this._initHeader());
        this._initMenuList();
...
/*
    ...
    _initMenuList() {
        ...
        let menuList = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<ul></ul>").addClass("menu-list");
        this._menuItemsList.forEach( item => {
            let listItem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<li></li>").appendTo(menuList);
            let span = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>").appendTo(listItem);
            span.text(item);
...
class Header {
    ...
    _init() {
        ...
        let ul = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<ul></ul>").addClass("header-list");
        for ( let key in this._options ) {
            ...
            let li = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()( "<li></li>" ).appendTo(ul);
            let span = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>").addClass(classStr)
                .text(`${key}: ${this._options[ key ]}`);

            //Додає обгортку для показу блоку біля поля Score
            if ( key === "Score" ) {
                _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("header-block")
                    .appendTo(li);
            }
...
class Info {
    ...
    _init() {
        ...
        this._message = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<p></p>").addClass("info-message")
            .text(this._text);
        this._elem = _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>").addClass("info")
...
class Game {
    ...
    _initEvent() {
        ...
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("keydown", ( e ) => {
            this.keys[ e.which ] = true;
        } );


        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("keyup", ( e ) => {
...
*/
        ...
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("dragstart", ( event ) => {
            event.preventDefault();
        } );

        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("mousedown", ( event ) => {
            event.preventDefault();
        } );
        ...
        _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_3___default()(document).on("contextmenu", ( event ) => {
...
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/jquery-3.4.1 */ "./lib/jquery-3.4.1.js");
/* harmony import */ var _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_1__);



//Запуск гри

let gameLounch = new _game__WEBPACK_IMPORTED_MODULE_0__["Game"]( _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_1___default()("#game-field" ), _lib_jquery_3_4_1__WEBPACK_IMPORTED_MODULE_1___default()( "#header-field" ) );
